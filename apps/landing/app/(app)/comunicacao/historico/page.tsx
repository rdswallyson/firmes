  ...
  return (
    <div className="page-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        ...
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0D2545", margin: 0 }}>Histórico de Envios</h1>
          <p style={{ color: "#6B7280", margin: "4px 0 0" }}>Em desenvolvimento</p>
        </div>
      </div>
      <div style={{ background: "white", borderRadius: 16, padding: 40, textAlign: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
        <History size={48} style={{ color: "#E5E7EB", marginBottom: 16 }} />
        <p style={{ color: "#6B7280", marginBottom: 16 }}>O histórico de envios será implementado em breve.</p>
