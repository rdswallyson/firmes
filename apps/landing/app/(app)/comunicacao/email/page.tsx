...
export default function ComunicacaoEmailPage() {
  return (
    <div className="page-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        ...
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0D2545", margin: 0 }}>E-mail em Massa</h1>
      ...
      <div style={{ background: "white", borderRadius: 16, padding: 40, textAlign: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}>
        ...
        <p style={{ color: "#6B7280", marginBottom: 16 }}>A funcionalidade de e-mail em massa está centralizada na página de Comunicação.</p>
        <Link
          href="/comunicacao"
          style={{
            padding: "10px 20px",
