    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Cartão digital", href: "/em-breve?modulo=cartao" },
          { label: "Auto-cadastro público", href: "/cadastro/igreja" },
          { label: "Importar via Excel", href: "/em-breve?modulo=importar" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Domínio personalizado", href: "/em-breve?modulo=dominio" },
          { label: "Faturamento Esmeralda", href: "/white-label/planos" },
          { label: "Material de vendas", href: "/em-breve?modulo=material" },
        ],
      },
      {
        id: "configuracoes",
