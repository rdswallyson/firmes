    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Membros", href: "/congregacoes/membros" },
          { label: "Últimos Cultos", href: "/congregacoes/cultos" },
          { label: "Financeiro do Mês", href: "/congregacoes/financeiro" },
          { label: "Próximos Eventos", href: "/congregacoes/eventos" },
