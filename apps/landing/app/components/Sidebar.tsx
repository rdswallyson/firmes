    ...
    items: [
      {
        ...
        children: [
          { label: "Todos os membros", href: "/membros" },
          { label: "Novo cadastro", href: "/membros/novo" },
          { label: "Aniversariantes", href: "/membros/aniversariantes" },
          { label: "Cartão digital", href: "/membros/cartao" },
          { label: "Auto-cadastro público", href: "/membros/autocadastro" },
          { label: "Importar via Excel", href: "/membros/importar" },
          { label: "Inativos / Ausentes", href: "/membros/inativos" },
        ],
      },
      {
        id: "grupos",
